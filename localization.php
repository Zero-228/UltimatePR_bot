...
$languages = array(
	'en' => array(
		...
		'subs_btn' => "Chanel ",
		'subs_msg' => "❗️{username}, you must subscribe to channels below\nto write in this group(",
		'lack_of_rights' => "Give me the admin rights or i can't work properly...",
		'' => "",
	...
	'ru' => array(
		...
		'add_chanel_btn' => '➕ Канал',
		'add_group_btn' => '➕ Группа',
		'chanel_added' => 'Группа добавлена',
		'chanel_exists' => 'Канал переподключён к боту',
		'chanel_removed' => 'Бот удалён из канала',
